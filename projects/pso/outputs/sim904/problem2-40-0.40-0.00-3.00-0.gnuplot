...
set arrow from -11.6555, 5.34937 to -9.65599, 7.10865
set arrow from 6.86905, 48.1312 to 7.398, 46.717
...
set arrow from 23.9752, -48.1615 to 20.1899, -46.7473
...
set arrow from 10.9838, 4.15581 to 13.2242, 4.70631
...
set arrow from 12.8701, 8.25722 to 14.7213, 5.29076
set arrow from -20.832, -23.4703 to -19.2322, -22.0561
set arrow from 34.6944, 9.33262 to 32.7355, 7.9184
...
set arrow from 16.753, -32.7617 to 16.8393, -31.3475
...
set arrow from -38.6024, 10.1839 to -36.6078, 9.85119
set arrow from -39.3466, 1.90523 to -37.3516, 3.31944
set arrow from 21.1965, -49.5861 to 18.3174, -48.1719
set arrow from 6.59354, 17.5957 to 8.02112, 16.1815
set arrow from 30.3182, -41.8377 to 26.8404, -40.4235
...
set arrow from 7.6101, 2.97455 to 9.53689, 4.38877
